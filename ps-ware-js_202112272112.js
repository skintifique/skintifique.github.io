...
//script to select reviews on avis client page
if (current_url.includes("/fr/avisclient")) {
//document.getElementsByClassName("pagination")[0].style.display = "none" ;
let img = document.getElementsByClassName("img-responsive") ;
var k ;
for (k = 0; k < img.length; k++) {
img[k].style.padding = "20px" ;
}
setTimeout(showOnlyReviews0,250)
//setTimeout(showOnlyReviews2,1000)
}
function showOnlyReviews0 () {
if (current_url.includes("skshow=reviewsframe")) {
...
document.getElementsByClassName("pagination")[0].style.display = "none" ;
setTimeout(showOnlyReviews2,250) ;
}
}
function showOnlyReviews2 () {
let skProductReviews ;
if (current_url.includes("skproduct=HG")) {
skProductReviews = "HG" ;
} else if (current_url.includes("skproduct=CL")) {
skProductReviews = "CL" ;
} else if (current_url.includes("skproduct=ML")) {
skProductReviews = "ML" ;
} else if (current_url.includes("skproduct=PC")) {
skProductReviews = "PC" ;
} else if (current_url.includes("skproduct=PSO")) {
skProductReviews = "PSO" ;
} else if (current_url.includes("skproduct=ECDE")) {
skProductReviews = "ECDE" ;
} else if (current_url.includes("skproduct=ACNE")) {
skProductReviews = "ACNE" ;
} else if (current_url.includes("skproduct=MATE")) {
skProductReviews = "MATE" ;
} else if (current_url.includes("skproduct=ALLG")) {
skProductReviews = "ALLG" ;
}
let xas = document.getElementsByTagName("A") ;
let aInnerText ;
let xelmt ;
switch (skProductReviews) {
case "HG":
//xas = document.getElementsByTagName("A") ;
var hg ;
for (hg = 0; hg < xas.length; hg++) {
//xas[hg].href = "" ;
xas[hg].removeAttribute("href");
aInnerText = xas[hg].innerHTML ;
if ((aInnerText.includes("Gel")) || (aInnerText.includes("gel")) || (aInnerText.includes("soriasis"))) {
xas[hg].parentElement.parentElement.style.display = "block" ;
} else {
xelmt = xas[hg].parentElement.parentElement ;
xelmt.style.display = "none" ;
}
}
break ;
case "ML":
//xas = document.getElementsByTagName("A") ;
var ml;
for (ml = 0; ml < xas.length; ml++) {
xas[ml].removeAttribute("href");
aInnerText = xas[ml].innerHTML ;
if ((aInnerText.includes("oisturi")) || (aInnerText.includes("ait"))) {
xas[ml].parentElement.parentElement.style.display = "block" ;
} else {
xelmt = xas[ml].parentElement.parentElement ;
xelmt.style.display = "none" ;
}
}
break;
...
//xas = document.getElementsByTagName("A") ;
var cl;
for (cl = 0; cl < xas.length; cl++) {
xas[cl].removeAttribute("href");
aInnerText = xas[cl].innerHTML ;
if ((aInnerText.includes("leanser")) || (aInnerText.includes("ettoyant"))) {
xas[cl].parentElement.parentElement.style.display = "block" ;
} else {
xelmt = xas[cl].parentElement.parentElement ;
xelmt.style.display = "none" ;
}
}
break;
case "PC":
var pc;
for (pc = 0; pc < xas.length; pc++) {
xas[pc].removeAttribute("href");
aInnerText = xas[pc].innerHTML ;
if ((aInnerText.includes("rotective")) || (aInnerText.includes("rotectrice")) || (aInnerText.includes("llerg"))) {
xas[pc].parentElement.parentElement.style.display = "block" ;
} else {
xelmt = xas[pc].parentElement.parentElement ;
xelmt.style.display = "none" ;
}
}
break;
case "PSO":
var pso;
for (pso = 0; pso < xas.length; pso++) {
xas[pso].removeAttribute("href");
aInnerText = xas[pso].innerHTML ;
if ((aInnerText.includes("soriasis"))) {
xas[pso].parentElement.parentElement.style.display = "block" ;
} else {
xelmt = xas[pso].parentElement.parentElement ;
xelmt.style.display = "none" ;
}
}
break;
case "ECDE":
var ecde;
for (ecde = 0; ecde < xas.length; ecde++) {
xas[ecde].removeAttribute("href");
aInnerText = xas[ecde].innerHTML ;
if ((aInnerText.includes("czema")) || (aInnerText.includes("ermati")) || (aInnerText.includes("llerg")) || (aInnerText.includes("yshidros")) || (aInnerText.includes("borrh"))) {
xas[ecde].parentElement.parentElement.style.display = "block" ;
} else {
xelmt = xas[ecde].parentElement.parentElement ;
xelmt.style.display = "none" ;
}
}
break;
case "ACNE":
var acne;
for (acne = 0; acne < xas.length; acne++) {
xas[acne].removeAttribute("href");
aInnerText = xas[acne].innerHTML ;
if ((aInnerText.includes("cne")) || (aInnerText.includes("ettoyant")) || (aInnerText.includes("leanser")) || (aInnerText.includes("ait")) || (aInnerText.includes("oisturi"))) {
xas[acne].parentElement.parentElement.style.display = "block" ;
} else {
xelmt = xas[acne].parentElement.parentElement ;
xelmt.style.display = "none" ;
}
}
break;
case "MATE":
var acne;
for (mate = 0; mate < xas.length; mate++) {
xas[mate].removeAttribute("href");
aInnerText = xas[mate].innerHTML ;
if ((aInnerText.includes("ettoyant")) || (aInnerText.includes("leanser")) || (aInnerText.includes("gel")) || (aInnerText.includes("Gel"))) {
xas[mate].parentElement.parentElement.style.display = "block" ;
} else {
xelmt = xas[mate].parentElement.parentElement ;
xelmt.style.display = "none" ;
}
}
break;
case "ALLG":
var allg;
for (allg = 0; allg < xas.length; allg++) {
xas[allg].removeAttribute("href");
aInnerText = xas[allg].innerHTML ;
if ((aInnerText.includes("ettoyant")) || (aInnerText.includes("leanser")) || (aInnerText.includes("rotect")) || (aInnerText.includes("ait")) || (aInnerText.includes("oisturi")) || (aInnerText.includes("llerg"))) {
xas[allg].parentElement.parentElement.style.display = "block" ;
} else {
xelmt = xas[allg].parentElement.parentElement ;
xelmt.style.display = "none" ;
}
}
break;
...
function cleanReviewsList() {
let clr10 = document.getElementsByClassName("clr_10") ;
var j2 ;
for (j2 = 0; j2 < clr10.length; j2++) {
clr10[j2].classList.add("hideElement") ;
clr10[j2].remove();
}
let clrHr = document.getElementsByClassName("clr_hr") ;
var j ;
for (j = 0; j < clrHr.length; j++) {
clrHr[j].classList.add("hideElement") ;
//clrHr[j].remove();
}
let clr5 = document.getElementsByClassName("clr_5") ;
var j1 ;
for (j1 = 0; j1 < clr5.length; j1++) {
clr5[j1].classList.add("hideElement") ;
clr5[j1].remove();
}
let xas = document.getElementsByTagName("A") ;
var a;
for (a = 0; a < xas.length; a++) {
xas[a].removeAttribute("href");
}
}
//END script to select reviews on avis client page
// script to select reviews to show on appropriate page
if (current_url.includes("/169-")) {
document.addEventListener("click", function(btn) {
let e = btn.target ;
let e_class = e.className ;
if (e_class === "reviewUsers") {
let e_value = e.value ;
let targ_url = "https://www.skintifique.me/shop/fr/avisclients?skshow=reviewsframe&skproduct=" + e_value ;
document.getElementById("iframeReviews").src = targ_url ;
} else if (e_class === "reviewUsersALL") {
let targ_url = "https://www.skintifique.me/shop/fr/avisclients?skshow=reviewsframe" ;
document.getElementById("iframeReviews").src = targ_url ;
}
});
}
// END script to select reviews to show on appropriate page
//script to show only client reviews on product page THIS SCRIPT CAN PROBABLY BE TOSSED
if (current_url.includes("skshow=reviewsORIGINAL")) {
document.getElementsByClassName("product-info-row")[0].style.display = "none" ;
//document.getElementsByClassName("alert-info")[0].style.display = "none" ;
setTimeout(showOnlyReviews,400);
}
...
//document.getElementsByClassName("product-info-row")[0].style.display = "none" ;
//document.getElementsByClassName("block-review-item")[0].style.display = "none" ;
document.getElementsByClassName("alert-info")[0].style.display = "none" ;
//document.getElementById("bt_btn-review-list").style.display = "none" ;
//document.getElementById("bt_btn-review-form").style.display = "none" ;
//check if desktop or mobile display
let mb = document.getElementById("product-infos-accordion-mobile-0") ;
///let mb = document.getElementsByClassName("nav-tabs")[0] ;
//END check if desktop or mobile display
if (mb) {
let navTabs = document.getElementsByClassName("nav-tabs") ;
var ta ;
for (ta = 0; ta < navTabs.length; ta++) {
navTabs[ta].style.display = "none" ;
}
//document.getElementById("ma-nav-link-0").style.display = "none" ;
//document.getElementById("ma-nav-link-1").style.display = "none" ;
//document.getElementById("ma-nav-link-2").style.display = "none" ;
//document.getElementById("ma-nav-link-3").style.display = "none" ;
//document.getElementById("ma-product-details-tab").style.display = "none" ;
//document.getElementsByClassName("nav-tabs")[0].style.display = "none" ;
document.getElementById("ma-description").style.display = "none" ;
document.getElementById("ma-avis-tab").parentElement.classList.add("active");
document.getElementById("ma-avis-tab").parentElement.classList.add("show");
document.getElementsByClassName("page-list")[0].style.display = "none" ;
//document.getElementById("product-infos-accordion-mobile-0").style.display = "none" ;
//document.getElementById("product-infos-accordion-mobile-1").style.display = "none" ;
//document.getElementById("product-infos-accordion-mobile-2").classList.add("show") ;
//document.getElementById("product-infos-accordion-mobile-2").classList.remove("collapse") ;
//tab_reviews.style.display = "block" ;
//tab_reviews.classList.remove("collapse") ;
//let content_reviews_id = "product-infos-accordion-mobile-" + tab_last ;
//let content_reviews_id = "product-infos-accordion-mobile-3" ;
//document.getElementById(content_reviews_id).classList.add("show") ;
} else {
document.getElementById("product-infos-tabs").style.visibility = "hidden" ;
//document.getElementById("product-infos-tabs").firstChild.style.display = "none" ;
//document.getElementById("description").classList.remove("active") ;
document.getElementById("description").style.display = "none" ;
//document.getElementById("product-details-tab").style.display = "none" ;
document.getElementById("avis-tab").classList.add("active") ;
document.getElementById("avis-tab").classList.add("show") ;
//document.getElementsByClassName("productBottom")[0].style.display = "none" ;
...
let iframeEmail = "https://form.jotform.com/213504657811050" + "?sGender=" + sGender + "&sSkinType=" + sSkinType + "&sFrequency=" + sFrequency + "&sArea=" + sArea + "&sConditions=" + sConditions + "&sOtherFactors=" + sOtherFactors + "&sIngredients=" + sIngredients + "&sIngredientsValues=" + sIngredientsValues + "&sRiskGroups=" + sRiskGroups + "&sRiskGroupsValues=" + sRiskGroupsValues ;
...
//case "notAllergicToAnyIngredient" :
//document.getElementById("ingredientsToExclude").innerText = "Vous n'avez indiqué aucun ingrédient à exclure" ;
//document.getElementById("ingredientsToExcludeValues").innerText = "9999999" ;
//document.getElementById("riskgroupsExclusionListLabels").innerText = "Vous n'avez indiqué aucun groupe d'ingrédients à exclure" ;
//document.getElementById("riskgroupsExclusionListValues").innerText = "9999999" ;
...
let productUrl_reviews = productUrl + "?skshow=reviewsframe" ;
