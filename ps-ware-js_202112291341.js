...
document.getElementsByClassName("pagination")[0].style.display = "none" ;
setTimeout(showOnlyReviews2,300) ;
}
}
...
} else if (current_url.includes("skproduct=TATT")) {
skProductReviews = "TATT" ;
}
//let xas = document.getElementsByTagName("A") ;
let xas = document.getElementsByClassName("review-line-list") ;
let aInnerText ;
let xelmt ;
...
aInnerText = xas[hg].innerText ;
if ((aInnerText.includes("el hydratant")) || (aInnerText.includes("ydrating gel"))) {
//xas[hg].parentElement.parentElement.style.display = "block" ;
xas[hg].style.display = "block" ;
} else {
...
aInnerText = xas[ml].innerText ;
if ((aInnerText.includes("oisturi")) || (aInnerText.includes("Lait")) || (aInnerText.includes("lait"))) {
//xas[ml].parentElement.parentElement.style.display = "block" ;
xas[ml].style.display = "block" ;
} else {
//xelmt = xas[ml].parentElement.parentElement ;
xas[ml].style.display = "none" ;
}
}
break;
case "CL":
...
aInnerText = xas[pc].innerText ;
if ((aInnerText.includes("rotective")) || (aInnerText.includes("rotectrice"))) {
//xas[pc].parentElement.parentElement.style.display = "block" ;
xas[pc].style.display = "block" ;
} else {
//xelmt = xas[pc].parentElement.parentElement ;
xas[pc].style.display = "none" ;
}
}
break;
case "PSO":
...
xas[ecde].style.display = "block" ;
} else {
//xelmt = xas[ecde].parentElement.parentElement ;
xas[ecde].style.display = "none" ;
}
}
break;
case "ACNE":
...
aInnerText = xas[acne].innerText ;
if ((aInnerText.includes("acne")) || (aInnerText.includes("ettoyant")) || (aInnerText.includes("leanser")) || (aInnerText.includes("lait")) || (aInnerText.includes("Lait")) || (aInnerText.includes("oisturi"))) {
//xas[acne].parentElement.parentElement.style.display = "block" ;
xas[acne].parentElement.parentElement.style.display = "block" ;
} else {
//xelmt = xas[acne].parentElement.parentElement ;
xas[acne].style.display = "none" ;
}
}
break;
case "MATE":
...
aInnerText = xas[mate].innerText ;
if ((aInnerText.includes("ettoyant")) || (aInnerText.includes("leanser")) || (aInnerText.includes("gel")) || (aInnerText.includes("Gel")) || (aInnerText.includes("regnant")) || (aInnerText.includes("nceinte")) || (aInnerText.includes("baby")) || (aInnerText.includes("bebe")) || (aInnerText.includes("ergeture")) || (aInnerText.includes("stretch mark")) || (aInnerText.includes("maman"))) {
//xas[mate].parentElement.parentElement.style.display = "block" ;
xas[mate].style.display = "block" ;
} else {
//xelmt = xas[mate].parentElement.parentElement ;
xas[mate].style.display = "none" ;
}
}
break;
case "ALLG":
...
aInnerText = xas[allg].innerText ;
if ((aInnerText.includes("rotect")) || (aInnerText.includes("llerg")) || (aInnerText.includes("ickel")) || (aInnerText.includes("obalt")) || (aInnerText.includes("hrome"))) {
//xas[allg].parentElement.parentElement.style.display = "block" ;
xas[allg].style.display = "block" ;
} else {
//xelmt = xas[allg].parentElement.parentElement ;
xas[allg].style.display = "none" ;
}
}
break;
case "TATT":
var tatt;
for (tatt = 0; tatt < xas.length; tatt++) {
//xas[tatt].removeAttribute("href");
aInnerText = xas[tatt].innerText ;
if ((aInnerText.includes("attoo")) || (aInnerText.includes("atouage")) || (aInnerText.includes("atoo"))) {
//xas[tatt].parentElement.parentElement.style.display = "block" ;
xas[tatt].style.display = "block" ;
} else {
//xelmt = xas[tatt].parentElement.parentElement ;
xas[tatt].style.display = "none" ;
}
}
break;
}
