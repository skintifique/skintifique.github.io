...
document.getElementById("test1").innerText = selectedConditions ;
...
if (lang === "fr-fr") {
textUnderMILABtn = "Merci de patienter quelques secondes, le temps d'afficher l'analyse" ;
} else {
textUnderMILABtn = "Please wait a few seconds for the profile to be completed and displayed below" ;
}
