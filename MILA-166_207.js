...
//script to show only client reviews on product page
if ((current_url.includes("?skshow=reviews")) || (current_url.includes("?skshow=avis"))) {
setTimeout(showOnlyReviews,500);
}
function showOnlyReviews () {
if ((current_url.includes("&skshowframe=reviewsframe")) || (current_url.includes("?skshowframe=avisframe"))) {
...
//let dk = document.getElementById("description").style.display ;
...
//document.getElementsByClassName("nav-tabs")[1].style.display = "none" ;
...
let tab_last = tabs.length - 1;
let tab_reviews = tabs[tab_last] ;
...
document.getElementById(content_reviews_id).classList.add("show").classList.add("show") ;
} else {
document.getElementById("product-infos-tabs").style.display = "none" ;
...
let productUrl_reviews = productUrl + "?skshow=reviews&skshowframe=reviewsframe" ;
...
//document.getElementById("confirmSKingredients").addEventListener("click",function () {
...
//document.getElementById("inputProduct_name").innerText = inputProduct ;
if (inputProduct) {
