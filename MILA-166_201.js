...
document.getElementsByClassName("accordionAllergicToReco")[0].classList.add("mySlides") ;
document.getElementsByClassName("accordionAllergicToReco")[1].classList.add("mySlides") ;
document.getElementsByClassName("accordionAllergicToSynthesis")[0].classList.add("mySlides") ;
}
...
// reset all diag_condition buttons to zero
...
if (selectedConditions.includes("reactive")) {
...
document.getElementsByClassName("accordionAllergicToReco")[0].classList.remove("mySlides") ;
document.getElementsByClassName("accordionAllergicToReco")[1].classList.remove("mySlides") ;
//document.getElementsByClassName("accordionAllergicToReco")[2].classList.remove("mySlides") ;
document.getElementsByClassName("accordionAllergicToSynthesis")[0].classList.remove("mySlides") ;
...
document.getElementById("openMILAprofile").addEventListener("click", function () {
...
document.getElementById("openMILAdiag").addEventListener("click", openMILA) ;
...
let textUnderMILABtn ;
if (lang === "fr-fr") {
textUnderMILABtn = "Merci de patienter quelques secondes, le temps d'afficher le profil de sûreté & éco-responsabilité" ;
} else {
textUnderMILABtn = "Please wait a few seconds for the safety & eco-responsibility profile to be displayed below" ;
}
